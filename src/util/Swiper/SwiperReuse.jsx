...
const SwiperReuse = ({ data, slidesPerView = 2, children }) => {
        ...
        <div className="pb-3">
            ...
            >
                ...
                <div className="flex gap-2 justify-end py-2">
                    <div
                        ref={prevRef}
                        className={`w-8 h-8 border rounded-full p-1 cursor-pointer flex items-center justify-center transition-all border-gray-300 ${isAtStart && "cursor-not-allowed opacity-30"}`}
