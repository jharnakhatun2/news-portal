    ...
    <>
      <div className="hero">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-center lg:text-start text-2xl lg:text-5xl font-bold pb-5">Log In!</h1>
            <div className="space-y-2  mx-auto">
              {/* Google button */}
              <button onClick={handleGoogleSignup} className="btn btn-outline btn-neutral w-full">
              ...
              {/* Facebook Button */}
              <button onClick={handleFacebookSignup} className="btn btn-outline btn-neutral w-full">
