        ...
        <div className="block lg:hidden">
            <div className="flex justify-between items-center py-3">
                ...
                <div className="flex items-center gap-5">
                    {user ? <span onClick={logout} className="bg-slate-400 px-4 py-1 text-white text-xs rounded-sm cursor-pointer">LOG OUT</span> : <Link to='login' className="bg-slate-400 px-2 py-1 cursor-pointer text-white text-xs rounded-sm">LOG IN</Link>}
